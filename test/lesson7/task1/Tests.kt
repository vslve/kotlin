...
разработки."""
    ...
    fun countSubstrings() {
        ...
        assertEquals(
            mapOf("ааааааавв" to 1),
            countSubstrings("input/substrings_in3.txt", listOf("ааааааавв"))
        )
        assertEquals(
            mapOf("аб" to 1),
            countSubstrings("input/substrings_in4.txt", listOf("аб"))
        )
        assertEquals(
            mapOf("бааааааб" to 1),
            countSubstrings("input/substrings_in5.txt", listOf("бааааааб"))
        )
        assertEquals(
        ...
        assertEquals(
            mapOf("щЩ" to 2),
            countSubstrings("input/substrings_in8.txt", listOf("щЩ"))
        )
    }
